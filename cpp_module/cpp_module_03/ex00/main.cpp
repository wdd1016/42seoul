...
int main()
{
    ...
    robot1.attack("Enemy11"); // Attack when energy points are 0 (Energy points become 0)
    robot1.attack("Enemy12"); // Attack when energy points are 0 (Energy points are still 0)
    ...
    robot2.beRepaired(5); // Hit points are now 5
    robot2.beRepaired(3); // Hit points are now 8
    robot2.beRepaired(12); // Hit points are now 20
    robot2.beRepaired(100); // Hit points are now 120
