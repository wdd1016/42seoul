...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_4_integer_bouns.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: juyojeon <juyojeon@student.42seoul.kr>     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/12 19:37:39 by juyojeon          #+#    #+#             */
/*   Updated: 2022/12/16 07:54:50 by juyojeon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	ft_bonus_itoa(int nbr, t_para *para, int *print_count, int len)
{
	int	count_zero;
...
int	ft_write_int(va_list ap, t_para *para, int *print_count)
{
	...
	if (ft_sign_int(nbr, para, print_count) < 0)
		return (-1);
	if (ft_bonus_itoa(nbr, para, print_count, abs_len) == -1)
		return (-1);
